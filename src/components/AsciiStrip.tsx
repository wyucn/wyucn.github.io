export default function AsciiStrip() {
  return (
    ...
    >
      ...
      <div className="shell flex min-h-11 items-center justify-between gap-5 font-mono text-[9px] font-bold tracking-[0.12em] uppercase md:text-[10px] md:tracking-[0.14em]">

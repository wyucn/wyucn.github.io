      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          {projects.map((project) => (
            <div
              key={project.id}
              className="work-card group interactive relative overflow-hidden rounded-2xl transition-all duration-500"
              style={{ background: "var(--c-surface)", border: "1px solid var(--c-border)" }}
              onMouseEnter={(e) => (e.currentTarget.style.borderColor = "var(--c-accent-30)")}

...
function CanvasPoster() {
  return <div className="absolute inset-0 overflow-hidden bg-[#11101b]" aria-hidden="true">
    ...
    <div className="absolute left-[5%] top-[11%] h-[56%] w-[78%] overflow-hidden border border-[#b4a5ff]/35 bg-[#e8eded] shadow-[22px_28px_70px_rgba(0,0,0,.45)] transition duration-700 ease-out group-hover:-translate-y-2 group-hover:-rotate-[.6deg]">
      <div className="absolute inset-x-0 top-0 z-10 flex h-4 items-center gap-1 border-b border-black/10 bg-[#edf0ef] px-2"><i className="h-1 w-1 rounded-full bg-[#ff765c]"/><i className="h-1 w-1 rounded-full bg-[#e8b84c]"/><i className="h-1 w-1 rounded-full bg-[#66c8ac]"/><span className="ml-auto font-mono text-[6px] tracking-[.14em] text-black/35">A111n / WORKFLOW MAP</span></div>
